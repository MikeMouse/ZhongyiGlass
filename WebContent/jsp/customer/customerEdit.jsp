...
<html>
    ...
    <div class="main">
        <html:form action="customerEdit.do" method="post">
	        <table border="0">
	            <tr>
	                <td colspan="3"><h2>添加顾客：</h2></td>
	            </tr>
	            <tr>
	                <td>姓名：</td>
	                <td>
                ...
                <tr>
                    ...
                    <td>&nbsp;<span id='mobilePhone_msg'></span>
                    </td>
                </tr>
                <tr>
                    <td>家庭电话：</td>
                    ...
                    <td>&nbsp;<span id='homePhone_msg'></span>
                    </td>
                </tr>
	            <tr></tr>
	            <tr>
	                <td>
	                    <input type="button" class="button" name="edit" id="edit" value="确定" onclick="customerConfirmSubmit();" />
	                </td>
	            </tr>
	        </table>
